                    ...
                    XeonBotInc.sendMessage(i, {
                        ...
                        contextInfo: {
                            externalAdReply: {
                                ...
                                thumbnailUrl: 'https://i.imgur.com/CfCJ43k.jpeg',
...
`.trim()
            ...
            case 'buyprem':
            case 'premium': {
                let teks = `Hi ${pushname}👋\nWant to Buy Premium? Just chat with the Tech God wa.me/254769365617 😉`
                await XeonBotInc.sendMessage(m.chat, {
                    text: teks,
                    contextInfo: {
                        externalAdReply: {
            ...
            case 'repo':
                XeonBotInc.sendMessage(m.chat, {
                    text: `repo https://github.com/finjohns/TECH-GOD-BUG-BOT
...
break
            ...
            case 'help':
            case 'alive':
                let xeonmenuoh = `╭══ *❍ JINWIIL 🕷️-BUG_BOT ❍*
┃❁ *ᴏᴡɴᴇʀ:* ᴛᴇᴄʜ ○■□● ɢᴏᴅ
